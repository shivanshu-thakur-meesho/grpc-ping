...
func (c *pingServiceClient) Ping(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PongResponse, error) {
...
func (UnimplementedPingServiceServer) Ping(context.Context, *Empty) (*PongResponse, error) {
